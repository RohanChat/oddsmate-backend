...
from scrapers.stats_scraping.utils.scrape_bio import scrape_fighter_stats       # should accept a fighter URL and return a dict
from scrapers.stats_scraping.utils.scrape_round import scrape_round_by_round_stats   # should accept (fight_url, fighter_url) and return a dict
from scrapers.stats_scraping.utils.scrape_pre_comp import scrape_precomp_stats   # should accept (fight_url, fighter_url) and return a dict
